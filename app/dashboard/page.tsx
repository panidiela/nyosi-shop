...
function EcranAcces({ onAcces }: { onAcces: (slug: string) => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#075E54] flex flex-col items-center justify-center px-6">
      <Image src="/logo-blanc.png" alt="Nyosi" width={100} height={39} priority className="h-10 w-auto object-contain mb-8" />
      ...
      <div className="px-4 -mt-5 flex flex-col gap-4 pb-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 card-fade-in">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 rounded-xl bg-[#075E54] flex items-center justify-center">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 card-fade-in">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-9 h-9 rounded-xl bg-[#FCB001] flex items-center justify-center">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
